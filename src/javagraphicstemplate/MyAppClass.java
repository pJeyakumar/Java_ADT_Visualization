...
System.out.println("keyReleased="+KeyEvent.getKeyText(e.getKeyCode()));
        ...
        { 
            ...
            if (intScreen == 0)
            {
                ...
                // Subtitles
                me.setColor(Color.DARK_GRAY);
            	me.setFont(new Font("Serif",Font.ITALIC, 36));
                me.drawString("ADT Structures", 150, 125);
                me.drawString("Elementary Sorts", 525, 125);
                // Options
                me.setColor(Color.BLACK);
                me.setFont(new Font("Serif",Font.PLAIN,36));
                me.drawString("Press 1 for Linked List",100,200);
                me.drawString("Press 2 for Stack",100,250);
                me.drawString("Press 3 for Queue",100,300);
                me.drawString("Press 4 for Binary Tree",100,350);
                me.drawString("Press 5 for Bubble Sort",500,200);
                me.drawString("Press 6 for Insertion Sort",500,250);
                me.drawString("Press 7 for Selection Sort",500,300);
                me.drawString("Press 8 for Quick Sort",500,350);   
                me.drawString("Press 9 for Merge Sort", 500, 400);
                me.drawString("Press S for Shell Sort", 500, 450);
            }
